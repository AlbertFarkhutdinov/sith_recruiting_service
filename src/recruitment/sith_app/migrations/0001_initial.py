    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_shadow_hand', models.BooleanField(default=False, verbose_name='Is Shadow Hand?')),
                ('answers', models.CharField(default='', max_length=3, verbose_name='Answers')),
                ('master', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shadow_hands', to='sith_app.sith', verbose_name='Master')),
